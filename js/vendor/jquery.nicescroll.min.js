...
!(function (e) {
  ...
  l
    ? window.cancelAnimationFrame || (a = function (e) {})
    : ((l = function (e, o) {
  ...
  var c = window.MutationObserver || window.WebKitMutationObserver || !1,
    ...
    h = function () {
      ...
      return (
        ...
        (i.isie9 =
          i.isie && "performance" in window && 9 === document.documentMode),
        (i.isie10 =
          i.isie && "performance" in window && 10 === document.documentMode),
        (i.isie11 = "msRequestFullscreen" in e && document.documentMode >= 11),
        (i.ismsedge = "msCredentials" in window),
        (i.isie9mobile = /iemobile.9/i.test(t)),
        i.isie9mobile && (i.isie9 = !1),
        (i.isie7mobile = !i.isie9mobile && i.isie7 && /iemobile/i.test(t)),
        (i.ismozilla = "MozAppearance" in o),
        (i.iswebkit = !i.ismsedge && "WebkitAppearance" in o),
        (i.ischrome = !i.ismsedge && "chrome" in window),
    ...
    p = function (e, u) {
      ...
      function v(e, o, t) {
        ...
        if (
          (0 == e.deltaMode
            ? ((r = -Math.floor(e.deltaX * (b.opt.mousescrollstep / 54))),
              (i = -Math.floor(e.deltaY * (b.opt.mousescrollstep / 54))))
            : 1 == e.deltaMode &&
              ((r = -Math.floor(e.deltaX * b.opt.mousescrollstep)),
              (i = -Math.floor(e.deltaY * b.opt.mousescrollstep))),
          o &&
            b.opt.oneaxismousemode &&
            0 == r &&
            i &&
            ((r = i),
            (i = 0),
      ...
      if (
        (b.opt.disablemutationobserver && (c = !1),
        (this.doc = b.opt.doc),
        ...
        (this.win = b.opt.win || (this.ispage ? s(window) : this.doc)),
        (this.docscroll =
          this.ispage && !this.haswrapper ? s(window) : this.win),
        (this.body = s("body")),
        (this.viewport = !1),
        (this.isfixed = !1),
        (this.iframe = !1),
        ...
        var x = this.win[0] == window ? this.body : this.win,
          S =
            x.css("writing-mode") ||
            x.css("-webkit-writing-mode") ||
            x.css("-ms-writing-mode") ||
            x.css("-moz-writing-mode");
        "horizontal-tb" == S || "lr-tb" == S || "" == S
          ? ((this.isrtlmode = "rtl" == x.css("direction")),
            (this.isvertical = !1))
          : ((this.isrtlmode =
              "vertical-rl" == S || "tb" == S || "tb-rl" == S || "rl-tb" == S),
            (this.isvertical =
              "vertical-rl" == S || "tb" == S || "tb-rl" == S));
      ...
      (this.canhwscroll = z.hastransform && b.opt.hwacceleration),
        (this.ishwscroll = this.canhwscroll && b.haswrapper),
        this.isrtlmode
          ? this.isvertical
            ? (this.hasreversehr = !(z.iswebkit || z.isie || z.isie11))
            : (this.hasreversehr = !(
                z.iswebkit ||
                (z.isie && !z.isie10 && !z.isie11)
              ))
          : (this.hasreversehr = !1),
        (this.istouchcapable = !1),
        z.cantouch || (!z.hasw3ctouch && !z.hasmstouch)
          ? !z.cantouch ||
            z.isios ||
            z.isandroid ||
            (!z.iswebkit && !z.ismozilla) ||
            (this.istouchcapable = !0)
          : (this.istouchcapable = !0),
        b.opt.enablemouselockapi ||
          ((z.hasmousecapture = !1), (z.haspointerlock = !1)),
      ...
      if (
        ...
        z.hastranslate3d && b.opt.enabletranslate3d
      ...
      if (
        ...
        (this.updateScrollBar = function (e) {
          ...
          if (b.ishwscroll)
            b.rail.css({
              height:
                b.win.innerHeight() -
                (b.opt.railpadding.top + b.opt.railpadding.bottom),
            }),
              b.railh &&
                b.railh.css({
                  width:
                    b.win.innerWidth() -
                    (b.opt.railpadding.left + b.opt.railpadding.right),
                });
          else {
            var r = b.getOffset();
            if (
              ((o = {
                top: r.top,
                left:
                  r.left - (b.opt.railpadding.left + b.opt.railpadding.right),
              }),
              (o.top += g(b.win, "border-top-width", !0)),
              (o.left += b.rail.align
                ? b.win.outerWidth() -
                  g(b.win, "border-right-width") -
                  b.rail.width
                : g(b.win, "border-left-width")),
              (t = b.opt.railoffset) &&
              ...
              b.zoom &&
                b.zoom.css({
                  top: o.top + 1,
                  left:
                    1 == b.rail.align ? o.left - 20 : o.left + b.rail.width + 4,
                }),
          ...
          b.railslocked ||
            ...
            o
              ? (r = t ? b.doScrollLeft : b.doScrollTop)(
                  (n = t
                    ? (e.pageX - b.railh.offset().left - b.cursorwidth / 2) *
                      b.scrollratio.x
                    : (e.pageY - b.rail.offset().top - b.cursorheight / 2) *
                      b.scrollratio.y)
                )
              : ((r = t ? b.doScrollLeftBy : b.doScrollBy),
                (n = t ? b.scroll.x : b.scroll.y),
                (s = t
        ...
        (b.hasanimationframe = "requestAnimationFrame" in window),
        (b.hascancelanimationframe = "cancelAnimationFrame" in window),
        (this.init = function () {
          if (((b.saved.css = []), z.isie7mobile)) return !0;
          if (z.isoperamini) return !0;
          if (z.isandroid && !("hidden" in document)) return !0;
          var e =
            z.ismodernie || z.isie10
              ? { "-ms-overflow-style": "none" }
              : { "overflow-y": "hidden" };
          if (
            ((b.opt.emulatetouch = b.opt.emulatetouch || b.opt.touchbehavior),
            (b.zindex = "auto"),
            b.ispage || "auto" != b.opt.zindex
              ? (b.zindex = b.opt.zindex)
              : (b.zindex = f() || "auto"),
            ...
            b.isie &&
              ...
              "auto" == b.opt.zindex &&
              (b.zindex = "auto"),
            !b.ispage || (!z.cantouch && !z.isieold && !z.isie9mobile))
          ) {
            var i = b.docscroll;
            b.ispage && (i = b.haswrapper ? b.win : b.doc),
              z.isie9mobile || b.css(i, e),
              b.ispage &&
                z.isie7 &&
                ("BODY" == b.doc[0].nodeName
                  ? b.css(s("html"), { "overflow-y": "hidden" })
                  : "HTML" == b.doc[0].nodeName && b.css(s("body"), e)),
              !z.isios ||
                b.ispage ||
                b.haswrapper ||
                b.css(s("body"), { "-webkit-overflow-scrolling": "touch" });
            ...
            l.css({
              ...
              (l.hborder = parseFloat(l.outerHeight() - l.innerHeight())),
              l.addClass("nicescroll-cursors"),
              (b.cursor = l);
            var a = s(document.createElement("div"));
            a.attr("id", b.id),
              a.addClass("nicescroll-rails nicescroll-rails-vr");
            var d,
              u,
              h = ["left", "right", "top", "bottom"];
            for (var p in h)
              (u = h[p]),
                (d = b.opt.railpadding[u])
                  ? a.css("padding-" + u, d + "px")
                  : (b.opt.railpadding[u] = 0);
            a.append(l),
              (a.width = Math.max(
                parseFloat(b.opt.cursorwidth),
                l.outerWidth()
              )),
              a.css({
                width: a.width + "px",
            ...
            !b.opt.boxzoom ||
              ...
              b.bind(g, "click", b.doZoom),
              b.bind(g, "mouseenter", function () {
            ...
            var w;
            if (
              (b.opt.horizrailenabled &&
                (b.css(i, { overflowX: "hidden" }),
                ...
                z.isieold && l.css("overflow", "hidden"),
                (l.wborder = parseFloat(l.outerWidth() - l.innerWidth())),
                l.addClass("nicescroll-cursors"),
                (b.cursorh = l),
                (w = s(document.createElement("div"))).attr("id", b.id + "-hr"),
                ...
                (w.visibility = !0),
                (w.scrollable = !0),
                (w.align = "top" == b.opt.railvalign ? 0 : 1),
                (b.railh = w),
                (b.railh.drag = !1)),
              b.ispage)
            )
              a.css({ position: "fixed", top: 0, height: "100%" }),
              ...
              if (b.ishwscroll) {
                ...
                b.isfixed || (b.viewport = b.getViewport(b.win[0])),
                  b.viewport &&
                    ((b.body = b.viewport),
                    0 == /fixed|absolute/.test(b.viewport.css("position")) &&
                      b.css(b.viewport, { position: "relative" })),
                  a.css({ position: y }),
                  b.zoom && b.zoom.css({ position: y }),
                  b.updateScrollBar(),
                  b.body.append(a),
                  b.zoom && b.body.append(b.zoom),
                  b.railh && (w.css({ position: y }), b.body.append(w));
              }
              z.isios &&
                b.css(b.win, {
            ...
            if (
              (!1 === b.opt.autohidemode
                ...
                ? ((b.autohidedom = s().add(b.rail)),
                  z.isie8 && (b.autohidedom = b.autohidedom.add(b.cursor)),
              ...
              (b.scrollmom = new m(b)),
                (b.onmangotouch = function () {
                  var e = b.getScrollTop(),
                    o = b.getScrollLeft();
                  if (
                    e == b.scrollmom.lastscrolly &&
                    o == b.scrollmom.lastscrollx
                  )
                    return !0;
                  var t = e - b.mangotouch.sy,
                    r = o - b.mangotouch.sx;
                  if (
                    0 != Math.round(Math.sqrt(Math.pow(r, 2) + Math.pow(t, 2)))
                  ) {
                    var i = t < 0 ? -1 : 1,
                      n = r < 0 ? -1 : 1,
                      s = +new Date();
                    if (
                      ...
                      s - b.mangotouch.tm > 80 ||
                        b.mangotouch.dry != i ||
                        b.mangotouch.drx != n)
                    )
                      b.scrollmom.stop(),
                        b.scrollmom.reset(o, e),
                        (b.mangotouch.sy = e),
                        (b.mangotouch.ly = e),
                        (b.mangotouch.sx = o),
                        (b.mangotouch.lx = o),
                      ...
                      b.scrollmom.stop(),
                        ...
                        (b.mangotouch.tm = s);
                      var l = Math.max(
                        Math.abs(b.mangotouch.ly - e),
                        Math.abs(b.mangotouch.lx - o)
                      );
                      (b.mangotouch.ly = e),
                        (b.mangotouch.lx = o),
                        l > 2 &&
              ...
              if (
                  ...
                  (b.ontouchstart = function (e) {
                    ...
                    if (((b.hasmoving = !1), !b.railslocked)) {
                      ...
                      if (
                        ...
                        b.ispage || !b.opt.directionlockdeadzone)
                      )
                        b.rail.drag.dl = "f";
                      else {
                        var i = { w: s(window).width(), h: s(window).height() },
                          n = {
                            w: Math.max(
                        ...
                        !b.rail.scrollable && b.railh.scrollable
                          ? (b.rail.drag.ck = l > 0 && "v")
                          : b.rail.scrollable && !b.railh.scrollable
                          ? (b.rail.drag.ck = a > 0 && "h")
                          : (b.rail.drag.ck = !1),
                      ...
                      if (
                        ...
                        !z.cantouch && !this.istouchcapable && !e.pointerType)
                      ) {
                        if (
                          !(
                            !!o &&
                            /INPUT|SELECT|BUTTON|TEXTAREA/i.test(o.nodeName)
                          )
                        )
                          return (
                            !b.ispage && z.hasmousecapture && o.setCapture(),
                            b.opt.emulatetouch
                              ? (o.onclick &&
                                  !o._onclick &&
                        ...
                        /SUBMIT|CANCEL|BUTTON/i.test(s(o).attr("type")) &&
                    ...
                    if (2 == b.rail.drag.pt) {
                      ...
                      if (
                        ...
                        b.hasmoving &&
                          ...
                          (b.lastmouseup = !0),
                          b.hideCursor(),
                          z.hasmousecapture && document.releaseCapture(),
                          !z.cantouch))
                      )
                ...
                (b.ontouchmove = function (e, o) {
                  ...
                  if (
                    e.targetTouches &&
                    b.opt.preventmultitouchscrolling &&
                  ...
                  if ((z.isandroid && b.cancelEvent(e), 2 == b.rail.drag.pt)) {
                    if (
                      ("changedTouches" in (e = s.extend({ original: e }, e)) &&
                        ((e.clientX = e.changedTouches[0].clientX),
                        (e.clientY = e.changedTouches[0].clientY)),
                      b.forcescreen)
                    ) {
                    ...
                    b.ishwscroll && b.opt.bouncescroll
                      ? u < 0
                        ? (u = Math.round(u / 2))
                        : u > b.page.maxh &&
                          (u = b.page.maxh + Math.round((u - b.page.maxh) / 2))
                      : (u < 0 && ((u = 0), (l = 0)),
                        u > b.page.maxh && ((u = b.page.maxh), (l = 0)));
                    var h;
                    b.railh &&
                      b.railh.scrollable &&
                      ((h = b.isrtlmode
                      ...
                      b.ishwscroll && b.opt.bouncescroll
                        ? h < 0
                          ...
                          : h > b.page.maxw &&
                            (h =
                              b.page.maxw + Math.round((h - b.page.maxw) / 2))
                        : (h < 0 && ((h = 0), (c = 0)),
                          h > b.page.maxw && ((h = b.page.maxw), (c = 0))));
                    var p = !1;
                    if (b.rail.drag.dl)
                      (p = !0),
                        "v" == b.rail.drag.dl
                          ? (h = b.rail.drag.sl)
                          : "h" == b.rail.drag.dl && (u = b.rail.drag.st);
                    else {
                      var m = Math.abs(a),
                        f = Math.abs(d),
                      ...
                      if ("v" == b.rail.drag.ck) {
                        ...
                        f > g &&
                          ((b.rail.drag.dl = "f"),
                          s("body").scrollTop(s("body").scrollTop()));
                      } else if ("h" == b.rail.drag.ck) {
                        if (f > g && m <= 0.3 * f)
                          return (b.rail.drag = !1), !0;
                        m > g &&
                          ((b.rail.drag.dl = "f"),
                          s("body").scrollLeft(s("body").scrollLeft()));
                      }
                    }
                    if (
                      (b.synched("touchmove", function () {
                        b.rail.drag &&
                          ...
                          b.rail.scrollable && b.setScrollTop(u),
                          b.scrollmom.update(c, l),
                          b.railh && b.railh.scrollable
                            ? (b.setScrollLeft(h), b.showCursor(u, h))
                            : b.showCursor(u),
                          z.isie10 && document.selection.clear());
                      }),
                      z.ischrome && b.istouchcapable && (p = !1),
                      p)
                    )
                      return b.cancelEvent(e);
                  ...
                  (b.ontouchstartCursor = function (e, o) {
                    if (!b.rail.drag || 3 == b.rail.drag.pt) {
                      ...
                      var t = b.getTarget(e);
                      return (
                        !b.ispage && z.hasmousecapture && t.setCapture(),
                        b.isiframe &&
                          !z.hasmousecapture &&
                  ...
                  (b.ontouchmoveCursor = function (e) {
                    if (b.rail.drag) {
                      ...
                      if (((b.cursorfreezed = !0), b.rail.drag.hr)) {
                        (b.scroll.x =
                          b.rail.drag.sx +
                          (e.touches[0].clientX - b.rail.drag.x)),
                        ...
                        (b.scroll.y =
                          b.rail.drag.sy +
                          (e.touches[0].clientY - b.rail.drag.y)),
              ...
              if (
                ...
                (b.onmousemove = function (e) {
                  if (b.rail.drag) {
                    ...
                    if (
                      ...
                      (b.scroll.x =
                        b.rail.drag.sx + (e.clientX - b.rail.drag.x)),
                        b.scroll.x < 0 && (b.scroll.x = 0);
                      var o = b.scrollvaluemaxw;
                      b.scroll.x > o && (b.scroll.x = o);
                    } else {
                      (b.scroll.y =
                        b.rail.drag.sy + (e.clientY - b.rail.drag.y)),
                        b.scroll.y < 0 && (b.scroll.y = 0);
                      var t = b.scrollvaluemax;
                      b.scroll.y > t && (b.scroll.y = t);
                    }
                ...
                (b.onpreventclick = function (e) {
                  ...
                  b.opt.grabcursorenabled &&
                    ...
                    b.css(b.rail, { cursor: z.cursorgrabvalue }));
              else {
                var k = function (e) {
                  if (b.selectiondrag) {
                    if (e) {
              ...
              z.hasw3ctouch
                ? (b.css(b.ispage ? s("html") : b.win, {
                    "touch-action": "none",
                  }),
                  b.css(b.rail, { "touch-action": "none" }),
                  b.css(b.cursor, { "touch-action": "none" }),
                  b.bind(b.win, "pointerdown", b.ontouchstart),
                  b.bind(document, "pointerup", b.ontouchend),
                  b.bind(document, "pointermove", b.ontouchmove))
                : z.hasmstouch
                ? (b.css(b.ispage ? s("html") : b.win, {
                ...
                : z.cantouch &&
                  (b.bind(b.win, "touchstart", b.ontouchstart, !1, !0),
                  b.bind(document, "touchend", b.ontouchend, !1, !0),
                  b.bind(document, "touchcancel", b.ontouchend, !1, !0),
                  b.bind(document, "touchmove", b.ontouchmove, !1, !0)),
                b.opt.emulatetouch &&
                  (b.bind(b.win, "mousedown", b.ontouchstart, !1, !0),
                  b.bind(document, "mouseup", b.ontouchend, !1, !0),
                  b.bind(document, "mousemove", b.ontouchmove, !1, !0)),
                ...
                b.opt.cursordragontouch &&
                  (this.istouchcapable || z.cantouch) &&
                  ...
                  b.cursorh &&
                    b.bind(b.cursorh, "touchmove", b.ontouchmoveCursor),
                  b.cursorh &&
                    b.bind(b.cursorh, "touchend", b.ontouchendCursor)),
                z.cantouch || b.opt.emulatetouch
                  ? (b.bind(
                      z.hasmousecapture ? b.win : document,
                      "mouseup",
                      b.ontouchend
                    ),
                  ...
                  : (b.bind(
                    ...
                    !b.ispage &&
                      ...
                      b.cursorh &&
                        b.bind(b.cursorh, "mouseup", b.onselectionend),
                ...
                b.opt.enablemousewheel &&
                  (b.isiframe ||
                    b.mousewheel(
                      z.isie && b.ispage ? document : b.win,
                      b.onmousewheel
                    ),
                ...
                b.ispage ||
                  ...
                  (b.win.attr("tabindex") || b.win.attr({ tabindex: r++ }),
                  b.jqbind(b.win, "focus", function (e) {
                    (o = b.getTarget(e).id || !0),
                      (b.hasfocus = !0),
            ...
            if (
              ((b.onkeypress = function (e) {
                ...
                if (
                  ...
                  switch (i) {
                    ...
                    case 63232:
                      b.railh &&
                        (n ? b.doScrollLeft(0) : b.doScrollLeftBy(72),
                        (a = !0));
                      break;
                    case 39:
                    case 63234:
                    ...
                    case 36:
                    case 63273:
                      b.railh && n ? b.doScrollPos(0, 0) : b.doScrollTo(0),
                        (a = !0);
                      break;
                    case 35:
                    case 63275:
              ...
              b.opt.enablekeyboard &&
                b.bind(
                  document,
                  z.isopera && !z.isopera12 ? "keypress" : "keydown",
                  b.onkeypress
                ),
              ...
              z.ischrome && !b.ispage && !b.haswrapper)
            ) {
            ...
            (b.onAttributeChange = function (e) {
              ...
              b.opt.enableobserver &&
                (b.isie11 ||
                  !1 === c ||
                  ((b.observerbody = new c(function (e) {
                    if (
                      (e.forEach(function (e) {
                        if ("attributes" == e.type)
                          return s("body").hasClass("modal-open") &&
                            s("body").hasClass("modal-dialog") &&
                            !s.contains(s(".modal-dialog")[0], b.doc[0])
                            ? b.hide()
                            : b.show();
                      }),
                ...
                b.ispage ||
                  ...
                  (!1 !== c
                    ...
                    : (b.bind(
                      ...
                      b.bind(b.win, "DOMNodeRemoved", function (e) {
            ...
            var L = function () {
              ...
              try {
                (o =
                  "contentDocument" in this
                    ...
                    : this.contentWindow.document).domain;
              } catch (e) {
                (b.iframexd = !0), (o = !1);
              }
              if (b.iframexd)
              ...
              if (
                ...
                b.isiframe &&
                  ...
                  (b.docscroll = s(b.iframe.body))),
                !z.isios && b.opt.iframeautoresize && !b.isiframe)
              ) {
              ...
              b.lazyResize(30),
                z.isie7 && b.css(s(b.iframe.html), e),
                b.css(s(b.iframe.body), e),
                z.isios &&
                  b.haswrapper &&
                  b.css(s(o.body), {
                ...
                b.opt.enablemousewheel && b.mousewheel(o, b.onmousewheel),
                b.opt.enablekeyboard &&
                  b.bind(o, z.isopera ? "keypress" : "keydown", b.onkeypress),
                z.cantouch
                  ...
                  : b.opt.emulatetouch &&
                    ...
                    b.opt.grabcursorenabled &&
                      z.cursorgrabvalue &&
                      b.css(s(o.body), { cursor: z.cursorgrabvalue })),
                b.bind(o, "mouseup", b.ontouchend),
                b.zoom &&
                  (b.opt.dblclickzoom && b.bind(o, "dblclick", b.doZoom),
                  b.ongesturezoom && b.bind(o, "gestureend", b.ongesturezoom));
            };
          ...
          if (
            ...
            if (
              ...
              (b.rail.drag && 1 == b.rail.drag.pt) ||
                (void 0 !== e &&
                  !1 !== e &&
                  (b.scroll.y = Math.round((1 * e) / b.scrollratio.y)),
                void 0 !== o &&
                  (b.scroll.x = Math.round((1 * o) / b.scrollratio.x))),
              ...
              !b.rail.align && b.rail.visibility
                ...
                : b.cursorh.css({ width: b.cursorwidth, left: t }),
                (b.cursoractive = !0);
            }
              ...
              ((b.hasmousefocus && "leave" == b.opt.autohidemode) ||
                (b.cursortimeout = setTimeout(function () {
                  (b.rail.active && b.showonmouseevent) ||
                    (b.autohidedom
                      .stop()
                      .animate({ opacity: b.opt.cursoropacitymin }),
                    b.zoom &&
                      b.zoom
                        .stop()
                        .animate({ opacity: b.opt.cursoropacitymin }),
        ...
        (this.onResize = function (e, o) {
          ...
          return (
            ...
            0 == b.page.maxw
              ...
              : ((b.page.maxw -=
                  b.opt.railpadding.left + b.opt.railpadding.right),
                b.railh && (b.railh.scrollable = b.opt.horizrailenabled)),
            (b.railslocked =
              b.locked || (0 == b.page.maxh && 0 == b.page.maxw)),
            b.railslocked
              ? (b.ispage || b.updateScrollBar(b.view), !1)
              : (b.hidden || b.visibility
                  ? !b.railh || b.hidden || b.railh.visibility || b.showRailHr()
        ...
        (this.lazyResize = function (e) {
          return (
            b.haswrapper || b.hide(),
            b.hlazyresize && clearTimeout(b.hlazyresize),
            (b.hlazyresize = setTimeout(function () {
              b && (b.resize(), b.show());
            }, 240)),
            b
          );
        ...
        (this.jqbind = function (e, o, t) {
          b.events.push({ e: e, n: o, f: t, q: !0 }), s(e).bind(o, t);
        }),
          ...
          if ("onwheel" in document.createElement("div"))
            ...
            var i =
              void 0 !== document.onmousewheel
                ...
                : "DOMMouseScroll";
            w(r, i, o, t || !1),
              "DOMMouseScroll" == i && w(r, "MozMousePixelScroll", o, t || !1);
          }
        }),
        z.haseventlistener)
      ) {
        ...
        (this._bind = function (e, o, t, r, i) {
          ...
          (this.cancelEvent = function (e) {
            return (
              !!e &&
              ((e = e.original ? e.original : e).cancelable &&
                e.preventDefault(),
              e.stopPropagation(),
        ...
        (this.bind = function (e, o, t, r) {
          ...
          b._bind(i, o, function (e) {
            return (
              ...
              (!1 !== t.call(i, e) && !1 !== r) || b.cancelEvent(e)
            );
          });
        }),
      ...
      (this.unbindAll = function () {
        ...
        (this.hideRailHr = function () {
          return b.railh
            ? ((b.railh.visibility = !1), b.railh.css("display", "none"), b)
            : b;
        }),
        (this.show = function () {
          return (
            (b.hidden = !1), (b.railslocked = !1), b.showRail().showRailHr()
          );
        }),
        (this.hide = function () {
          return (
            (b.hidden = !0), (b.railslocked = !0), b.hideRail().hideRailHr()
          );
        }),
        ...
        (this.onmousewheel = function (e) {
          if (!b.wheelprevented) {
            ...
            if (
              ...
              b.opt.oneaxismousemode && 0 == e.deltaX && !b.rail.scrollable)
            )
              return !b.railh || !b.railh.scrollable || b.onmousewheelhr(e);
            var o = +new Date(),
              t = !1;
            if (
        ...
        (this.onmousewheelhr = function (e) {
          if (!b.wheelprevented) {
            ...
            return (
              ...
              (b.checkarea = o),
              !!b.nativescrollingarea ||
                (b.railslocked ? b.cancelEvent(e) : v(e, !0, t))
            );
          }
        }),
        (this.stop = function () {
        ...
        b.opt.smoothscroll
          ? b.ishwscroll &&
            ...
            ? ((this.prepareTransition = function (e, o) {
                ...
                return (
                  (b.lasttransitionstyle && b.lasttransitionstyle == r) ||
                    ((b.lasttransitionstyle = r),
                    b.doc.css(z.transitionstyle, r)),
                  t
                );
              }),
              ...
              (this.doScrollPos = function (e, o, t) {
                ...
                return (
                  ((b.newscrolly - r) * (o - r) < 0 ||
                    ...
                    b.cancelScroll(),
                  0 == b.opt.bouncescroll &&
                    (o < 0 ? (o = 0) : o > b.page.maxh && (o = b.page.maxh),
                  ...
                  (!b.scrollrunning ||
                    ...
                    ((b.newscrolly = o),
                    (b.newscrollx = e),
                    (b.newscrollspeed = t || !1),
                    !b.timer &&
                      void (b.timer = setTimeout(function () {
                        ...
                        var n = Math.round(
                          ...
                          s =
                            b.newscrollspeed && b.newscrollspeed > 1
                              ? b.newscrollspeed
                              : b.getTransitionSpeed(n);
                        if (
                          (b.newscrollspeed &&
                            b.newscrollspeed <= 1 &&
                            (s *= b.newscrollspeed),
                          b.prepareTransition(s, !0),
                          b.timerscroll &&
                            b.timerscroll.tm &&
                          ...
                          var a = t,
                            c = r;
                          (b.timerscroll = {
                            bz: new k(a, b.newscrolly, s, 0, 0, 0.58, 1),
                            bh: new k(c, b.newscrollx, s, 0, 0, 0.58, 1),
                          }),
                            b.cursorfreezed ||
                        ...
                        b.synched("doScroll-set", function () {
                          (b.timer = 0),
                            ...
                            b.scrollendtrapped || b.onScrollTransitionEnd();
                        });
                      }, 50)))
                );
              }),
              (this.cancelScroll = function () {
                ...
                return (
                  (b.scrollrunning = !1),
                  z.transitionend || clearTimeout(z.transitionend),
                  (b.scrollendtrapped = !1),
                  b._unbind(b.doc[0], z.transitionend, b.onScrollTransitionEnd),
              ...
              (this.onScrollTransitionEnd = function () {
                ...
                if (
                  ...
                  o < 0 ? (o = 0) : o > b.page.maxw && (o = b.page.maxw),
                  e != b.newscrolly || o != b.newscrollx)
                )
                  return b.doScrollPos(o, e, b.opt.snapbackspeed);
            ...
            : ((this.doScrollLeft = function (e, o) {
              ...
              (this.doScrollPos = function (e, o, t) {
                function r() {
                  ...
                  if (((b.scrollrunning = !0), (h = 1 - h)))
                    return (b.timer = l(r) || 1);
                  var e,
                    o,
                    t = 0,
                    i = (o = b.getScrollTop());
                  ...
                  2 == t
                    ? ((b.timer = 0),
                      ...
                      i < 0
                        ? (i = 0)
                        : i > b.page.maxh && (i = Math.max(0, b.page.maxh)),
                      n < 0 ? (n = 0) : n > b.page.maxw && (n = b.page.maxw),
                      n != b.newscrollx || i != b.newscrolly
                        ? b.doScrollPos(n, i)
                        : b.onscrollend && b.triggerScrollEnd())
                    : (b.timer = l(r) || 1);
                }
                var o = void 0 === o || !1 === o ? b.getScrollTop(!0) : o;
                if (b.timer && b.newscrolly == o && b.newscrollx == e)
                  return !0;
                b.timer && a(b.timer), (b.timer = 0);
                var i = b.getScrollTop(),
                  n = b.getScrollLeft();
                ((b.newscrolly - i) * (o - i) < 0 ||
                  (b.newscrollx - n) * (e - n) < 0) &&
                  b.cancelScroll(),
                  (b.newscrolly = o),
                  (b.newscrollx = e),
                ...
                var c = 0,
                  d = s;
                0 == b.dst.x
                  ? ((c = i), (d = o), (b.dst.ay = 1), (b.dst.py = 0))
                  : 0 == b.dst.y &&
                    ((c = n), (d = e), (b.dst.ax = 1), (b.dst.px = 0));
                ...
                if (
                  ...
                  (b.bzscroll =
                    u > 0 &&
                    (b.bzscroll
                      ? b.bzscroll.update(d, u)
                      : new k(c, d, u, 0, 1, 0, 1))),
                  !b.timer)
                ) {
                  ((i == b.page.maxh && o >= b.page.maxh) ||
                    (n == b.page.maxw && e >= b.page.maxw)) &&
                    b.checkContentSize();
                  var h = 1;
                  if (
                    ((b.cancelAnimationFrame = !1),
                    (b.timer = 1),
                    b.onscrollstart && !b.scrollrunning)
                  ) {
                    var p = {
                      type: "scrollstart",
                      current: { x: n, y: i },
        ...
        (this.doScrollBy = function (e, o) {
          ...
          if (
            ((t = o
              ? Math.floor((b.scroll.y - e) * b.scrollratio.y)
              : (b.timer ? b.newscrolly : b.getScrollTop(!0)) - e),
            b.bouncescroll)
          ) {
          ...
          return t < 0 && i <= 0
            ? b.noticeCursor()
            : t > b.page.maxh && i >= b.page.maxh
            ? (b.checkContentSize(), b.noticeCursor())
            : void b.doScrollTop(t);
        }),
        (this.doScrollLeftBy = function (e, o) {
          var t = 0;
          if (
            ((t = o
              ? Math.floor((b.scroll.x - e) * b.scrollratio.x)
              : (b.timer ? b.newscrollx : b.getScrollLeft(!0)) - e),
            b.bouncescroll)
          ) {
          ...
          return t < 0 && i <= 0
            ? b.noticeCursor()
            : t > b.page.maxw && i >= b.page.maxw
            ? b.noticeCursor()
            : void b.doScrollLeft(t);
        }),
        ...
        (this.doZoomIn = function (e) {
          if (!b.zoomactive) {
            ...
            (b.zoomrestore.style.width = b.win.css("width")),
              ...
              z.isios4 &&
                ((b.zoomrestore.scrollTop = s(window).scrollTop()),
            ...
            return (
              ("" == l ||
                /transparent|rgba\(0, 0, 0, 0\)|rgba\(0,0,0,0\)/.test(l)) &&
        ...
        (this.doZoomOut = function (e) {
          if (b.zoomactive)
            return (
              ...
              z.isios4 && s(window).scrollTop(b.zoomrestore.scrollTop),
  ...
  (e.cssHooks.pageYOffset = {
    ...
    set: function (e, o) {
      ...
      return (
        t && t.ishwscroll ? t.setScrollTop(parseInt(o)) : f.call(e, o), this
      );
    },
  }),
  ...
  (s.cssHooks.pageXOffset = {
    ...
    set: function (e, o) {
      var t = s.data(e, "__nicescroll") || !1;
      return (
        t && t.ishwscroll ? t.setScrollLeft(parseInt(o)) : g.call(e, o), this
      );
    },
  }),
  ...
  !(function (e, o, t) {
    ...
    (s.fn.niceScroll = function (e, o) {
      ...
      var r = !("doc" in o);
      return (
        r || "win" in o || (o.win = s(this)),
        this.each(function () {
          var e = s(this).data("__nicescroll") || !1;
          e ||
            ((o.doc = r ? s(this) : o.doc),
            (e = new p(o, s(this))),
            s(this).data("__nicescroll", e)),
            t.push(e);
        }),
        1 == t.length ? t[0] : t
      );
